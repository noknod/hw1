...
ALL_FILES_FILE = '../count/data/dates_users_files_done.txt'

DONE_FILES_FILE = './data/m4_1_files_done.txt'
...
def main():
    ...
    for file_path in all_files:
        if file_path not in done_files:
            ...
            command = 'hdfs dfs -get hw1/metrics/{0}/m4_1.txt ../metrics/{0}/'.format(file_date)
