...
DONE_FILES_FILE = '../data/new_facebook_users_files_done.txt'
...
def main():
    ...
    for file_path in all_files:
        if file_path not in done_files:
            ...
            if file_path.split('/')[-2] < '2017-11-10':
                #break
                continue
            ...
            command = 'hdfs dfs -cp out/part-00000 hw1/metrics/{0}/new_facebook_users.txt'.format(dir_path)
